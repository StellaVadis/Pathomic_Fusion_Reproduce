...
def main(glioma_type):
    ...
    for k in range(1,16,1):
        ...
        checkpoint_path = f'../checkpoints/TCGA_GBMLGG/surv_15_rnaseq/omic/omic_{k}.pt'
    ...
    # The 320 GENES names in TCGA-GBMLGG
    ...
    file_path = f'../Interpretation/TCGA_GBMLGG/IG/IG_omic_{glioma_type}.pkl'
    ...
    plt.title(f'IG Contributions for Top Features {glioma_type} (omic)')
    plt.grid(True, axis='x', linestyle='--', alpha=0.7)
    plt.tight_layout()
    plt.savefig(f'../Interpretation/TCGA_GBMLGG/IG/IG_omic_{glioma_type}.png')
