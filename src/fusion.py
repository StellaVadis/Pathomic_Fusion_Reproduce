...
class BilinearFusion(nn.Module):
    ...
    def forward(self, vec1, vec2):
        ...
        #print('bmm shape:',torch.bmm(o1.unsqueeze(2), o2.unsqueeze(1)).shape)
        o12 = torch.bmm(o1.unsqueeze(2), o2.unsqueeze(1)).flatten(start_dim=1) # BATCH_SIZE X 1024
        #print('flatten o12 shape',o12.shape)
        out = self.post_fusion_dropout(o12)
        #print('post dropout out  shape:',out.shape)
        out = self.encoder1(out)
        #print('encoder 1 out shape:',out.shape)
        if self.skip: out = torch.cat((out, o1, o2), 1)
        #print('skip connection out shape:',out.shape)
        out = self.encoder2(out)
        #print('encoder 2 out shape:',out.shape)
        return out
