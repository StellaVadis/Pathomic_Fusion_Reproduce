...
#print(pat2img['TCGA-02-0001'])
#print(len(pat2img['TCGA-02-0001']))
...
def rename_file(filename):
    ...
    suffixes = [
        '_0_0.png', '_0_256.png', '_0_512.png', 
        '_256_0.png', '_256_256.png', '_256_512.png', 
        '_512_0.png', '_512_256.png', '_512_512.png','.png'
    ]
    
    for suffix in suffixes:
        if filename.endswith(suffix):
            new_filename = filename.replace(suffix, '.pt')
            return new_filename
    return filename
...
def getAlignedMultimodalData(opt, model, device, all_dataset, pat_split, pat2img):
    ...
    for pat_name in pat_split:
        ...
        for img_fname in pat2img[pat_name]:
            ...
            grph_fname = rename_file(img_fname)
            # grph_fname = img_fname[:-4] +'.pt'
    ...
    filtered_columns = all_dataset[all_dataset['TCGA ID'] == pat_name].drop(metadata, axis=1).columns

    
    '''
    with open('column_names.txt', 'w') as f:
        f.write('\n'.join(filtered_columns.tolist()))
    '''
